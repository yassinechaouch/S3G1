    ...
    return (
        ...
        <div className='card-container'>
            <section className='img-card-section'>
                ...
                <img alt='background' className='img-card-style' src={IM6}></img>   
            </section>
            ...
            Sophomore Student at the Mediterranean Institute of Technology.
            </section>
            ...
            <img alt='profile' className="profile-img-card" src={P2}></img>
        </div>
